	...
	<c:if test="${empty projectList }">
		...
		<div class="mx-auto align-items-center" style="border: 1px solid #ced4da; font-size: 15px;  width:96%;">
			<c:forEach items="${projectList}" var="prolist">
			  ...
			  <div onclick="location.href='<%=request.getContextPath() %>/roadmap/list/stu?project_id=${prolist.project_id }'; 
			  				window.parent.location.hash='<%=request.getContextPath() %>/roadmap/list/stu?project_id=${prolist.project_id }';"  style="cursor:pointer;">
			  <c:choose>
